...
export function WallpaperBackground() {
  ...
  return (
    ...
    >
      <motion.div style={{ x, y }} className="absolute -top-24 left-8 h-80 w-80 rounded-full bg-sky-200/70 blur-3xl" />
      <motion.div style={{ x: xFar, y: yFar }} className="absolute right-0 top-16 h-[28rem] w-[28rem] rounded-full bg-violet-200/60 blur-3xl" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.9),transparent_45%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(248,250,252,0.72),rgba(241,245,249,0.94))]" />
